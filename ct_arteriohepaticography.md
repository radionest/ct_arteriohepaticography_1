...
![Рис. 1 КТ с внутриартериальным контрастированием при вариантной анатомии печеночных сосудов, 22 секунда сканирования. а — контрастирование левой доли печени б — контрастирование правой доли печени](img/img1_1.jpeg)


![Рис. 2 КТ с внутриартериальным контрастирование. а – нативная фаза б – возвратная мезентерико-портальная фаза сканирования.](img/img2_1.jpeg)
...
![Рис.3 КТ: а — нативная фаза б — первая фаза контрастирование (22 секунда) в — вторая фаза контрастирования (38 секунда). Отмечается накопление контрастного препарата по периферии ободком метастаза.Уменьшение выраженности участков транзиторного усиления печени во второй фазе сканирования по сравнению с первой.](img/img3_1.jpeg)
