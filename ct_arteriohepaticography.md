...
Ободок накопления является известным признаком метастаза печени при КТ и МРТ с высокой специфичностью, но встречается только в 35-89% метастазов колоректального рака [@chengEnhancedRimMDCT2020]. <!--Надо подумать. Вероятно стоит про высокую специфичность ободка перенести в предыдущий абзац-->
