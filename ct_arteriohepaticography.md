...
Балахнин и соавторы описали методику ПДКТ инфузионной артериогепатикографии с задержкой на 22 секунде для получения капиллярной фазы и показали ее высокую эффективность в визуализации гиповаскулярных метастазов [@balakhnin2018intraarterial]. Воспроизводимость методики при адаптации к спиральной КТ подтверждается достижением капиллярной фазы контрастирования на 22 секунде у 57% пациентов. В данную фазу контрастное вещество отсутствует в печеночных артериях, присутствует в паренхиме печени и печеночных венах, при этом минимизируется контрастирование портальной вены. При вариантной анатомии целиако-мезентериального бассейна (в нашем исследовании 3 и 9 типы по N.Michels) последовательное введение контрастного препарата в правую и левую печеночные артерии и выполнение сканирования на 22 секунде не препятствует воспроизведению капиллярной фазы.

В нашем исследовании у 10 пациентов проводилась вторая фаза сканирования на 38 секунде. Эффективность сканирования с такой задержкой оказалась сопоставимой по частоте выявления гиперваскулярного ободка со сканированием на 22 секунде, но превосходила ее по качеству изображений за счет уменьшения артефактов транзиторного усиления печени. Inoue et al. показали, что при двухфазной КТ-артериографии 80% метастазов в печени демонстрировали контрастирование ободка на 12 секунде, а 73% сохраняли это контрастирование на 32 секунде, что подтверждает сохранение визуализации ободка при более поздних временных точках [@inoue1998double]. Li et al. продемонстрировали, что при многофазной КТ-артериогепатикографии гиперваскулярный ободок сохранялся на 40 секунде сканирования, при этом ни псевдопоражения, ни гемангиомы не показывали подобное контрастирование, что улучшает дифференциальную диагностику [@li2004multi]. Многофазное сканирование помогает распознать ложноположительные находки и повышает точность выявления метастазов печени, а более позднее время сканирования позволяет избежать ранних перфузионных артефактов, характерных для фазы 20-25 секунд, обеспечивая оптимальный баланс между визуализацией патологии и качеством изображения [@li2004multi].

Предлагаемый протокол КТ-артериогепатикографии обладает потенциальным преимуществом в визуализации метастазов колоректального рака в печени по сравнению со стандартным КТ-исследованием. Превосходство методики подтверждается выявлением дополнительных метастазов в 9,9% случаев, исчезнувших после химиотерапии и не визуализируемых при стандартном КТ [@vanderlei2023added]. Ценность заключается в том, что исчезнувшие при КТ с внутривенным контрастированием метастазы сохраняют потенциал к рецидивированию, поэтому такие находки определяют объем дальнейшего интервенционного или оперативного вмешательства и позволяют более точно оценивать ответ на проводимое лечение. Puijk et al. продемонстрировали, что КТ-артериогепатикография при термоаблации метастазов печени приводит к снижению частоты локального прогрессирования с 32,8% до 8,9% [@puijk2020transcatheter]. Характерный паттерн гиперваскулярного ободка позволяет надежно дифференцировать жизнеспособную опухолевую ткань от постабляционных рубцовых изменений при низком уровне ложноположительных результатов (7%) [@vanderlei2023added].

При выполнении КТ-артериогепатикографии на 22 секунде сканирования транзиторное усиление паренхимы печени определялось в 43% случаев и создавало диагностические трудности в выявлении метастазов в виде маскировки мелких очагов или имитации патологических изменений. Сканирование с задержкой на 38 секунде позволяет минимизировать выраженность этих перфузионных изменений при сохранении визуализации ободка контрастирования метастазов. Интерпретацию изображений также затрудняет контрастирование портальной вены из бассейна гастродуоденальной артерии, как в нашем случае при смещении катетера из общей печеночной артерии.
...
Капиллярная фаза контрастирования на 22 секунде является информативной для выявления гиперваскулярного ободка — высокоспецифичного признака метастатического поражения. Альтернативой может служить сканирование с задержкой на 38 секунде, которое характеризуется меньшей выраженностью артефактов и сохранением визуализации ободка контрастирования.