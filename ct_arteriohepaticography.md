...
У 6 пациентов проводили вторую фазу сканирвания на 33-38 секундах. Выбор задержки был обусловлен минимальным временем, необходимым для возврата стола томографа и подготовки к повторному сканированию. 
...
У 4 пациентов с фазами контрастирования на 22 и 38 секундах было выявлено 7 метастазов, их количество и наличие гиперваскулярного ободка в разные фазы сканирования идентично. У 2 пациентов с фазами коонтрастирования на 22 и 33-35 секундах гиперваскулярный ободок определялся у 8 метастазов. 

У 1 пациента с фазами контрастирования на 22 и 33 секундах гиперваскулярный ободок у 4 метастазов не определялся, что вероятно связано с выраженной кальцинацией очагов.
